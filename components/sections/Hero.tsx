...
export const Hero = () => {
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-purple-900/10 dark:to-blue-900/10 flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 relative overflow-hidden py-8 lg:py-0">
      {/* Fond 3D */}
      ...
      {/* Contenu Principal */}
      <div className="flex-1 relative z-10 text-center lg:text-left mb-8 lg:mb-0 mt-12 lg:mt-0">
        <div className="max-w-xl mx-auto lg:mx-0">
          <h2 className="text-base sm:text-lg mb-2 sm:mb-4 text-gray-600 dark:text-gray-300">Bonjour, je suis Nidhal,</h2>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight" style={{ color: "#008090" }}>
            Développeur<br />
            Web Junior
          </h1>
          <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-8 lg:mb-10 text-gray-600 dark:text-gray-300 px-4 sm:px-0">
      ...
      <div className="flex-1 flex justify-center relative z-10">
        <div className="relative w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px]">
          <div className="absolute right-[-10px] sm:right-[-15px] lg:right-[-20px] top-[-10px] sm:top-[-15px] lg:top-[-20px] text-2xl sm:text-3xl lg:text-4xl rotate-12 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400">++</div>
            ...
            <div className="absolute bottom-0 left-0 right-0">
              <div className="flex justify-center gap-1 sm:gap-2 mb-3 sm:mb-4 lg:mb-6">
                {Array(5).fill("").map((_, i) => (
                  <div key={i} className="w-4 sm:w-5 lg:w-6 h-1 sm:h-1.5 bg-gradient-to-r from-purple-500/20 to-blue-500/20 dark:from-purple-400/20 dark:to-blue-400/20 rounded-full" />
                ))}
              </div>
            </div>
          </div>
        ...
        {/* Liens Sociaux */}
        <div className="absolute bottom-0 right-0 flex gap-3 sm:gap-4 lg:gap-6 mb-3 sm:mb-4 lg:mb-6">
